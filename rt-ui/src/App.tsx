  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <Alert showIcon  message='warning Title' description='warning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Title' ></Alert>
        <Alert type={AlertType.Error} showIcon  message='warning Title' description='warning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Titlewarning Title' ></Alert>
        <Alert type={AlertType.Success} showIcon closable closeText="close text" message='Success Title' description='success description success descriptionsuccess descriptionsuccess description'></Alert>
